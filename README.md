...
| [**Player Scouting Analytics**](https://github.com/NguyenIslandBoy/gk-scouting) | A goalkeeper recruitment and profiling dashboard built on StatsBomb open data. Designed to mirror the two-step workflow: identify candidates from the market, then deep-dive any individual player with visual evidence | Python | processing 626 matches of StatsBomb open data, computing PSxG-GA, sweeper actions, and distribution metrics across 55 goalkeepers |
